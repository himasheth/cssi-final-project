let playerImage, enemyImage, bg, bulletImage, tower, zombie;
...
function setup() {
  ...
  // image setup
  bg = loadImage(
    "https://cdn.glitch.com/7cf7bcda-0dff-42d0-89c4-8abe95c3426c%2Fcherry.jpg?v=1596169601748"
  );
  playerImage = loadImage(
    "https://cdn.glitch.com/7cf7bcda-0dff-42d0-89c4-8abe95c3426c%2Fimageedit_1_3269043484.png?v=1596169767890"
  );
  enemyImage = loadImage(
    "https://cdn.glitch.com/7cf7bcda-0dff-42d0-89c4-8abe95c3426c%2Fwaiu.png?v=1596169803593"
  );
  bulletImage = loadImage(
    "https://cdn.glitch.com/ed6390d6-faba-4c19-b2c2-4194ddadbe00%2Fbullet.webp?v=1596167295549"
  );
  tower = loadImage(
    "https://cdn.glitch.com/7cf7bcda-0dff-42d0-89c4-8abe95c3426c%2Fimageedit_3_6860538429.png?v=1596170241560"
  );
  zombie = loadImage(
...
function levelComplete() {
  ...
  textSize(20);
  text("You completed Tokyo! Let's go to the next location!", 100, 450);
  pop();
  noLoop();
}
